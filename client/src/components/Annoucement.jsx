	...
	return (
		...
		>
			<p className="text-center w-full">
				...
				<Link to="/products">
					<button className="ml-2 capitalize font-medium underline underline-offset-4 decoration-2 text-orange-500 hover:tracking-wider transition-all duration-500">
						shop now
					</button>
				</Link>
			</p>
