...
const Login = () => {
  ...
  return (
    <div className="fixed top-0 left-0 bg-[url('/assets/register-bg.jpg')] bg-cover bg-bottom w-full min-h-screen h-full flex items-center justify-center select-none">
      <div className="sm:container md:mx-auto md:px-10 md:py-16 before:absolute before:top-0 before:left-0 before:w-full before:min-h-screen before:h-full before:bg-black/20 before:-z-10">
        <div className="flex items-center justify-center md:px-6 md:py-8 mx-auto md:h-screen lg:py-0">
          <div className="w-screen sm:w-full h-screen sm:h-fit pt-12 sm:pt-0 bg-white sm:rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
