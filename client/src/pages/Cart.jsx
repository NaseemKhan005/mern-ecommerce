			...
			<div>
				...
				<div className="flex md:items-center justify-between flex-col md:flex-row gap-3 md:gap-0 my-10">
					<Button
						...
						className="border-[1.5px] hover:border-black order-2 md:order-1"
					/>
					...
					<div className="flex-1 w-full flex flex-col gap-10">
						<div className="flex flex-col sm:flex-row gap-5 border-b pb-5 justify-between">
							...
							<div className="flex flex-col justify-between flex-1">
								...
								<p className="text-gray-500">893739489829</p>
								<span className="block w-5 aspect-square bg-black rounded-full cursor-pointer" />
								<p>
									<span className="font-medium mr-2 text-lg">Size:</span>
									<span>L</span>
								</p>
							</div>
